public class Sessel implements Transportierbar {
    ...
    public Sessel(String kennzeichnung, Boolean zerbrechlich, float gewicht, float laenge, float breite, float hoehe) {
