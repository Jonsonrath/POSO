public class Gabel implements Transportierbar{
    ...
    public Gabel(String kennzeichnung, Boolean zerbrechlich, float gewicht, float laenge, float breite, float hoehe) {
